...
//--------------------start initialise pixels ----------------------------------
//initialise pixels. See the explanation of the pixel class above.
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    PIXEL *pixel;
    malloc(&pixel, image_size*sizeof(PIXEL));
    EDGE *edge;
    malloc(&edge, No_of_Edges*sizeof(EDGE));;
